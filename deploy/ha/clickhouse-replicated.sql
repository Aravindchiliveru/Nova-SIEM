-- New replicated deployment only. Do not apply over an existing unreplicated table.
-- Requires operator-configured Keeper quorum and unique shard/replica macros.
...
) ENGINE = ReplicatedReplacingMergeTree('/clickhouse/tables/{shard}/nova/events','{replica}')
